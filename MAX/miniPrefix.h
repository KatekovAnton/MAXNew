...
typedef enum
{
    ...
    EXPLODE_SOUND_TYPE_LANDMINE_PLACE,//mlayer17
    EXPLODE_SOUND_TYPE_LANDMINE_REMOVE,//mlayer18
    EXPLODE_SOUND_TYPE_SEAMINE_PLACE,//smine17
    EXPLODE_SOUND_TYPE_SEAMINE_REMOVE,//smine18
}EXPLODE_SOUND_TYPE;
